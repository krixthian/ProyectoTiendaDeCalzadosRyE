    ...
    // Consulta para obtener solo los zapatos de tipo deportivo
    $sql = "SELECT * FROM zapato WHERE Tipo = 1"; // Tipo 1 corresponde a zapatos deportivos
    ...
    <head>
        ...
        <title>Zapatos Deportivos - Tienda RyE</title>
        <style>
    ...
    <body>
        ...
        <div class="container">
            <h2>Zapatos Deportivos Disponibles</h2>

            <?php
            // Verificar si hay zapatos deportivos
            if (mysqli_num_rows($result) > 0) {
                echo '<div class="shoe-grid">';
                // Mostrar los zapatos deportivos
    ...
    <div class="shoe-whatsapp">
        ...
        $message = urlencode("¡Hola! Estoy interesado en el zapato deportivo " . $row['Nombre'] . 
                           " (Talla: " . $row['Talla'] . 
        ...
        <a href="https://wa.me/<?php echo $whatsapp_number; ?>?text=<?php echo $message; ?>" 
           ...
           style="display: inline-block; margin-top: 10px; padding: 10px 15px; background-color: #25D366; color: white; text-decoration: none; border-radius: 5px;">
            Consultar en WhatsApp
                ...
                echo "<p>No hay zapatos deportivos disponibles actualmente.</p>";
            }
            ?>
        </div>
